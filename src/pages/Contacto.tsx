...
function Contacto() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.error(err)
      alert("Error al enviar el mensaje. Revisá la consola para más detalles.")
    } finally {
      setEnviando(false)
    }
  }
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="relative">
              ...
              <p className="font-serif text-piedra text-xl md:text-2xl lg:text-3xl leading-relaxed">
                EN MI AGENDA SOLO TENGO A JESUCRISTO<br /> <span className="text-dorado italic">SE EL SIGUIENTE</span>
              </p>
          </div>
          <div className="flex-1 space-y-6">
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
              ...
              {enviado ? (
                <div className="flex flex-col items-center gap-4 pt-10">
                  ...
                  <p className="font-serif text-xl md:text-2xl text-marfil text-center">
                    Gracias por tu mensaje, pronto recibirás noticias mías.
                  </p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-6">
                  <input type="text" name="from_name" placeholder="Nombre" required className={inputClass} />
                  <input type="number" name="edad" placeholder="Edad" min={0} required className={inputClass} />
                  <input type="email" name="reply_to" placeholder="Correo" required className={inputClass} />
                  <textarea
                    name="message"
                    placeholder="Mensaje"
                    required
                  ...
                  >
                    {enviando ? (
                      <><Loader className="h-5 w-5 animate-spin" /> Enviando...</>
                    ) : (
                      "Enviar Mensaje"
                    )}
                  </button>
            ...
            <div className="flex-1">
              ...
              <form className="space-y-6">
                ...
                <input type="email" name="correo" placeholder="Correo" required className={inputClass} />
                <input type="text" name="cantidad" placeholder="Cantidad €" required className={inputClass} />
                <textarea
                  name="mensaje"
              ...
              <div className="mt-8">
                ...
                >
                  ...
                  <span className="font-serif text-dorado text-base">STRIPE</span>
                </a>
              </div>
            </div>
          </div>
