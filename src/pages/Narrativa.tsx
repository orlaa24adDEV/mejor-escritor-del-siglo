...
export default function Narrativa() {
  return (
    <>
      ...
      <NarrativeBooks />
      <section className="bg-negro px-24 pb-50 flex flex-col items-center">
        <div className="flex flex-col items-center" style={{ width: "1400px" }}>
          ...
          <TriangleAlert className="text-dorado h-10 w-10"/>
          <h2 className="font-serif text-5xl text-dorado mb-6 text-center p-10">ALERTA INSITUCIONAL</h2>
          ...
          <p className="font-serif text-2xl text-marfil leading-relaxed text-center p-20">
            ...
            <div className="p-10">
              <h2 className="font-serif text-2xl text-marfil leading-relaxed text-center max-w-2xl">Nivel de presion institucional sobre el autor: <span className="font-bold text-dorado">MAXIMO</span></h2>
              <h2 className="font-serif text-2xl text-marfil leading-relaxed text-center max-w-2xl">Nuevas obras: <span className="font-bold text-dorado">PROXIMAMMENTE</span></h2>
            </div>
        </div>
      </section>
    </>
